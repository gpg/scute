/* settings.h - Settings for Scute's Cryptoki implementation.
...
/* Define this to 1 if threads are required for the implementation of
   the library.  */
#define NEED_TO_CREATE_THREADS 0
